...
def load_modis_l2_extension(flavor='std', datadir=None, filepath=None, local=False):
    """Extension of the Load up the MODIS L2 model.

    Args:
        flavor (str, optional): Type of model trained. Defaults to 'std'.
        datadir (str, optional): Path to data file for the model. Defaults to None.
        filepath (str, optional): Path to the (train, valid) data set for the model.
        local (bool, optional): If True, use local storage. Defaults to False.
